...
strVar += "";
strVar += "<p>Correctly:";
strVar += "<code>(feature1)$ git rebase develop<\/code>";
strVar += "{&lt;1>}<img src=\"\/content\/images\/2015\/03\/git-rebase.gif\" alt=\"\" title=\"\" \/>";
strVar += "and Incorrectly:";
strVar += "<code>(develop)$ git rebase feature1<\/code>";
strVar += "{&lt;2>}<img src=\"\/content\/images\/2015\/03\/git-rebase_Incorrect.gif\" alt=\"\" title=\"\" \/><\/p>";
strVar += "";
...
strVar += "";
strVar += "<p>Here's a git pull (technically a fetch, followed by a merge, it applies the pulled commits in after your work, and makes your history differ from the remote's):";
strVar += "{&lt;3>}<img src=\"\/content\/images\/2015\/04\/git-pull-no-rebase.gif\" alt=\"\" title=\"\" \/><\/p>";
strVar += "";
strVar += "<p>And here's a git pull --rebase.  You can see how it changes your history, but when you push up to your remote there will be no conflicts:";
strVar += "{&lt;4>}<img src=\"\/content\/images\/2015\/04\/git-pull--rebase.gif\" alt=\"\" title=\"\" \/><\/p>";
strVar += "";
